		...
		return new Promise<void>((resolve, reject) => {
			...
			childProcess.on('error', (error: Error) => {
				...
				if ((<any>error).code === 'ENOENT') {
					message = `Cannot lint ${textDocument.fileName}. The executable was not found. Use the '${this.linter.languageId}.linting.vulture.executablePath' setting to configure the location of the executable`;
				} else {
